...
public class DownloadProgressButton extends TextView {
    ...
    private void initAttrs(Context context, AttributeSet attrs) {
        ...
        mBackgroundColor = a.getColor(R.styleable.DownloadProgressButton_progressbtn_backgroud_color, Color.parseColor("#6699ff"));
        mBackgroundSecondColor = a.getColor(R.styleable.DownloadProgressButton_progressbtn_backgroud_second_color, Color.LTGRAY);
    ...
    private void init() {
        ...
        mBackgroundBorderPaint.setStrokeWidth(2);
    ...
    public void setState(int state) {
        if (mState != state) {//状态确实有改变
            this.mState = state;
            invalidate();
            if (state == DownloadProgressButton.INSTALLING) {
                //开启两个点动画
